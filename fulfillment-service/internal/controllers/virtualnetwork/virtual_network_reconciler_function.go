...
//go:generate mockgen -destination=virtual_networks_client_mock.go -package=virtualnetwork github.com/osac-project/osac/proto/gen/osac/private/v1 VirtualNetworksClient
