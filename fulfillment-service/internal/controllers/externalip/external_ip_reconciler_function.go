...
//go:generate mockgen -destination=external_ips_client_mock.go -package=externalip github.com/osac-project/osac/proto/gen/osac/private/v1 ExternalIPsClient
