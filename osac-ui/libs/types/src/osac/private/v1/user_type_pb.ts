...
// @generated from file osac/private/v1/user_type.proto (package osac.private.v1, syntax proto3)
/* eslint-disable */
 ...
 *
 * @generated from message osac.private.v1.User
 */
export type User = Message<"osac.private.v1.User"> & {
  /**
   ...
   *
   * @generated from field: osac.private.v1.UserSpec spec = 3;
   */
   ...
   * Status of the user.
   *
   * @generated from field: osac.private.v1.UserStatus status = 4;
   */
  status?: UserStatus | undefined;
};

/**
 * Describes the message osac.private.v1.User.
 * Use `create(UserSchema)` to create a new message.
 */
export const UserSchema: GenMessage<User> = /*@__PURE__*/
  messageDesc(file_osac_private_v1_user_type, 0);

/**
 * UserSpec contains the desired state of the user.
 *
 * @generated from message osac.private.v1.UserSpec
 */
export type UserSpec = Message<"osac.private.v1.UserSpec"> & {
  /**
   ...
   *
   * @generated from field: optional osac.private.v1.UserCredentials credentials = 4;
   */
  credentials?: UserCredentials | undefined;
};

/**
 * Describes the message osac.private.v1.UserSpec.
 * Use `create(UserSpecSchema)` to create a new message.
 */
export const UserSpecSchema: GenMessage<UserSpec> = /*@__PURE__*/
  messageDesc(file_osac_private_v1_user_type, 1);

/**
 * UserCredentials contains the authentication credentials for a user.
 *
 * @generated from message osac.private.v1.UserCredentials
 */
export type UserCredentials = Message<"osac.private.v1.UserCredentials"> & {
  /**
...
/**
 * Describes the message osac.private.v1.UserCredentials.
...
export const UserCredentialsSchema: GenMessage<UserCredentials> = /*@__PURE__*/
  messageDesc(file_osac_private_v1_user_type, 2);

/**
 * UserStatus contains the observed state of the user.
 *
 * @generated from message osac.private.v1.UserStatus
 */
export type UserStatus = Message<"osac.private.v1.UserStatus"> & {
  /**
   ...
   *
   * @generated from field: string keycloak_user_id = 3;
   */
  keycloakUserId: string;
};

/**
 * Describes the message osac.private.v1.UserStatus.
 * Use `create(UserStatusSchema)` to create a new message.
 */
export const UserStatusSchema: GenMessage<UserStatus> = /*@__PURE__*/
  messageDesc(file_osac_private_v1_user_type, 3);

/**
 * UserCondition represents a condition of a user.
 *
 * @generated from message osac.private.v1.UserCondition
 */
...
/**
 * Describes the message osac.private.v1.UserCondition.
