...
func (x *HostTypeReference) Reset() {
	*x = HostTypeReference{}
	mi := &file_osac_public_v1_host_type_type_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_osac_public_v1_host_type_type_proto_rawDesc = string([]byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x69, 0x0a, 0x11, 0x48, 0x6f, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65,
	...
	0xc3, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x73, 0x61, 0x63, 0x2e, 0x70, 0x75, 0x62,
	0x6c, 0x69, 0x63, 0x2e, 0x76, 0x31, 0x42, 0x11, 0x48, 0x6f, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65,
...
var file_osac_public_v1_host_type_type_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_osac_public_v1_host_type_type_proto_goTypes = []any{
	...
	(*HostTypeReference)(nil), // 2: osac.public.v1.HostTypeReference
	(*Metadata)(nil),          // 3: osac.public.v1.Metadata
}
var file_osac_public_v1_host_type_type_proto_depIdxs = []int32{
	3, // 0: osac.public.v1.HostType.metadata:type_name -> osac.public.v1.Metadata
