...
const (
	AddOnOperators_List_FullMethodName   = "/osac.private.v1.AddOnOperators/List"
	AddOnOperators_Get_FullMethodName    = "/osac.private.v1.AddOnOperators/Get"
	AddOnOperators_Create_FullMethodName = "/osac.private.v1.AddOnOperators/Create"
	AddOnOperators_Delete_FullMethodName = "/osac.private.v1.AddOnOperators/Delete"
	AddOnOperators_Update_FullMethodName = "/osac.private.v1.AddOnOperators/Update"
	AddOnOperators_Signal_FullMethodName = "/osac.private.v1.AddOnOperators/Signal"
)
...
type AddOnOperatorsClient interface {
	...
	Signal(ctx context.Context, in *AddOnOperatorsSignalRequest, opts ...grpc.CallOption) (*AddOnOperatorsSignalResponse, error)
}
...
func (c *addOnOperatorsClient) Signal(ctx context.Context, in *AddOnOperatorsSignalRequest, opts ...grpc.CallOption) (*AddOnOperatorsSignalResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddOnOperatorsSignalResponse)
	err := c.cc.Invoke(ctx, AddOnOperators_Signal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddOnOperatorsServer interface {
	...
	// Indicates that something changed in the object or the system that may require reconciling the object.
	Signal(context.Context, *AddOnOperatorsSignalRequest) (*AddOnOperatorsSignalResponse, error)
...
func (UnimplementedAddOnOperatorsServer) Signal(context.Context, *AddOnOperatorsSignalRequest) (*AddOnOperatorsSignalResponse, error) {
...
func _AddOnOperators_Signal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddOnOperatorsSignalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddOnOperatorsServer).Signal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AddOnOperators_Signal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddOnOperatorsServer).Signal(ctx, req.(*AddOnOperatorsSignalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AddOnOperators_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "osac.private.v1.AddOnOperators",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Signal",
			Handler:    _AddOnOperators_Signal_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "osac/private/v1/add_on_operators_service.proto",
}
